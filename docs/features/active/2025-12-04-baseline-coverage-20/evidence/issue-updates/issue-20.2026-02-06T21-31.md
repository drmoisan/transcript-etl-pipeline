...
Timestamp: 2026-02-06T21-31
Command: gh issue edit 20 --repo drmoisan/transcript-etl-pipeline --body-file artifacts/issue-20-body.2026-02-06T21-31.md
EXIT_CODE: 0

IssueNumber: 20
IssueURL: https://github.com/drmoisan/transcript-etl-pipeline/issues/20
PostedAs: body
IssueUpdatedAt: 2026-02-07T02:33:00Z
...
- [x] #24 Add fixtures and regression tests for 3+ speaker scenarios
- [x] #25 Add end-to-end tests for speakerless + notes flows (CLI)
- [x] #26 Add regression tests for notes conversion edge cases
- [x] #27 Add tests for formatters and document parser
...
- **Feature delivery inventory re-issued:**
  - `docs/features/active/2025-12-04-baseline-coverage-20/feature-delivery-inventory.2026-02-06T21-31.md`
